...
import RefundRequestTable from "@/components/PaymentManagement/RefundRequestTable";
        ...
        <div>
            <div className="border-b border-[#E5E9EB] h-[76px] px-4 lg:px-8">
                <div className="flex items-center pt-[18px]">
                    <p className="text-[#292D32] text-[24px] font-[600]">Payment Management</p>
                </div> 
            </div>
            <div className="h-[calc(100vh-155px)] overflow-y-auto custom-layout pb-20">
                <div className="mt-6 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-6">
                  <div><StatsCard number={"$54,000"} bgColor={"#F0F5FF"} textColor={"#2377FC"} title={"Total Revenue"} small={true}></StatsCard></div>
                  <div><StatsCard number={"$54,000"} bgColor={"#F0F5FF"} textColor={"#2377FC"} title={"Monthly Recurring Revenue"} small={true}></StatsCard></div>
                  <div><StatsCard number={200} bgColor={"#F0F5FF"} textColor={"#2377FC"} title={"Total Transactions"} small={true}></StatsCard></div>
                  <div><StatsCard number={"10%"} bgColor={"#F0F5FF"} textColor={"#2377FC"} title={"Refund Rate"} small={true}></StatsCard></div>
                  <div><StatsCard number={"05"} bgColor={"#F0F5FF"} textColor={"#2377FC"} title={"Failed Payments"} small={true}></StatsCard></div>
                </div>
                ...
                <div className="mt-6">
                    <RefundRequestTable></RefundRequestTable>
                </div>
            </div>
        </div>
    )
