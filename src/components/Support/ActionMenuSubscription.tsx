        ...
        >
          {options.map((option, index) => (
            <button
              ...
              className={`flex items-center p-2 text-[16px] font-[500] hover:bg-[#F0F5FF] w-full text-left rounded-[8px]`}
            >
              {option.icon}
...
export default ActionMenuSubscription;
